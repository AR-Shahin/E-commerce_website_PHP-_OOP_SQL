    ...
    <header class="header white-bg">
            ...
            <ul class="nav top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-success"><?= \App\classes\Product::countAllProduct()?></span>
                    </a>
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <p class="red">You have  new messages</p>
                        </li>
                ...
                <li id="header_notification_bar" class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-warning"><?= \App\classes\Category::countAllCategory()?></span>
                    </a>
                ...
                <li id="header_notification_bar" class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-info"><?= \App\classes\Order::countNewOrder()?></span>
                    </a>
        ...
        <div class="top-nav ">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="../uploads/" style="width: 35px">
                        <span class="username">
    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" <?= $page == 'addbrand.php' ? 'class="active"' : '' ?> <?= $page == 'managebrand.php' ? 'class="active"' : '' ?> >
                        <i class="fa fa-bitcoin (alias)"></i>
                        <span>Brand</span>
                    </a>
                    <ul class="sub">
                        <li <?= $page == 'addbrand.php' ? 'class="active"' : '' ?>><a  href="addbrand.php" >Add Brand</a></li>
                        <li <?= $page == 'managebrand.php' ? 'class="active"' : '' ?>><a  href="managebrand.php">Manage Brand</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" <?= $page == 'addproduct.php' ? 'class="active"' : '' ?> <?= $page == 'manageproduct.php' ? 'class="active"' : '' ?> >
                        <i class="fa fa-archive"></i>
                        <span>Product</span>
                    </a>
                    <ul class="sub">
                        <li <?= $page == 'addproduct.php' ? 'class="active"' : '' ?>><a  href="addproduct.php" >Add Product</a></li>
                        <li <?= $page == 'manageproduct.php' ? 'class="active"' : '' ?>><a  href="manageproduct.php">Manage Product</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" <?= $page == 'manageorder.php' ? 'class="active"' : '' ?> <?= $page == 'manageorder.php' ? 'class="active"' : '' ?> >
                        <i class="fa  fa-bullhorn"></i>
                        <span>Order</span>
                    </a>
                    <ul class="sub">
                        <li <?= $page == 'manageorder.php' ? 'class="active"' : '' ?>><a  href="manageorder.php" >Manage Order</a></li>
                    </ul>
                </li>
                <!-- site identity -->
                <li class="sub-menu">
