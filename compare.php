        ...
        <div class="row">
            ...
            <div class="span9">
                ...
                <table class="table table-bordered">
                    ...
                    if( \App\classes\Wishlist::ViewCompareProduct($cusId) === 0){
                        echo "<span class='error'>Not add!</span>";
                    }else{
                        $ob = \App\classes\Wishlist::ViewCompareProduct($cusId);
                        $i=0;
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                ...
                                <a href="logout.php?pid=<?= $row['id']?>" class="btn btn-danger" onclick="return confirm('Are you sure ?')" >Delete</a>
                            </td>
                        </tr>
                    <?php  }  }?>
